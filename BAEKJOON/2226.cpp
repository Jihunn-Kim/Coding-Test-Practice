...
BigInt Integer(string s) {
	...
	for (unsigned int i = 0; i < s.size(); i += 9) {
		int v = 0;
...
int main(void)
{
	...
	BigInt cnt_0 = Integer(0);
	BigInt cnt_1 = Integer(1);
	BigInt tmp_cnt_0 = Integer(0);
	BigInt tmp_cnt_1 = Integer(0);
	for (int i = 0; i < N - 1; ++i) {
		if (i % 2)
